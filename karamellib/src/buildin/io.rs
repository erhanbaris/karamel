...
impl IoModule {
    pub fn new() -> Rc<IoModule> {
        ...
        rc_module
            .methods
            .borrow_mut()
            .insert("satıroku".to_string(), FunctionReference::native_function(Self::readline as NativeCall, "satıroku".to_string(), rc_module.clone()));
        rc_module
            .methods
            .borrow_mut()
            .insert("satiroku".to_string(), FunctionReference::native_function(Self::readline as NativeCall, "satiroku".to_string(), rc_module.clone()));
        rc_module
            .methods
            .borrow_mut()
            .insert("yaz".to_string(), FunctionReference::native_function(Self::print as NativeCall, "yaz".to_string(), rc_module.clone()));
        rc_module
            .methods
            .borrow_mut()
            .insert("satıryaz".to_string(), FunctionReference::native_function(Self::printline as NativeCall, "satıryaz".to_string(), rc_module.clone()));
        rc_module
            .methods
            .borrow_mut()
            .insert("satiryaz".to_string(), FunctionReference::native_function(Self::printline as NativeCall, "satiryaz".to_string(), rc_module.clone()));
        rc_module
            .methods
            .borrow_mut()
            .insert("biçimlendir".to_string(), FunctionReference::native_function(Self::format as NativeCall, "biçimlendir".to_string(), rc_module.clone()));
        rc_module
            .methods
            .borrow_mut()
            .insert("bicimlendir".to_string(), FunctionReference::native_function(Self::format as NativeCall, "bicimlendir".to_string(), rc_module.clone()));
        rc_module.clone()
    }
    ...
    pub fn readline(_: FunctionParameter) -> NativeCallResult {
        ...
        match io::stdin().read_line(&mut line) {
            Ok(_) => Ok(VmObject::from(Rc::new(line.trim().to_string()))),
            _ => Ok(EMPTY_OBJECT),
        }
    }
