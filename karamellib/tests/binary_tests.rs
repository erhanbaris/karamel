...
mod tests {
    ...
    test_compare!(add_subtract_3, "5 * 2 mod 2 - 10", Ok(BramaAstType::Binary {
        left: Box::new(BramaAstType::Binary {
            left: Box::new(BramaAstType::Binary {
                left: Box::new(BramaAstType::Primative(Arc::new(BramaPrimative::Number(5.0)))),
    ...
    test_compare!(add_subtract_4, "22 + 5 * 2 mod 2", Ok(BramaAstType::Binary {
        left: Box::new(BramaAstType::Primative(Arc::new(BramaPrimative::Number(22.0)))), 
        operator: BramaOperatorType::Addition, 
    ...
    test_compare!(add_subtract_5, "11 + 12 + 13", Ok(BramaAstType::Binary {
        left: Box::new(BramaAstType::Binary {
            left: Box::new(BramaAstType::Primative(Arc::new(BramaPrimative::Number(11.0)))), 
            operator: BramaOperatorType::Addition, 
            right: Box::new(BramaAstType::Primative(Arc::new(BramaPrimative::Number(12.0))))
        }), 
        operator: BramaOperatorType::Addition, 
        right: Box::new(BramaAstType::Primative(Arc::new(BramaPrimative::Number(13.0))))
    }));
