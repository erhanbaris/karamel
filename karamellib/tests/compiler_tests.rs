...
mod tests {
    ...
    memory_check!(memory_5, "'erhan' + 'barış'", vec![BramaPrimative::Text(Arc::new("erhan".to_string())), BramaPrimative::Text(Arc::new("barış".to_string()))]);
    memory_check!(memory_6, "'erhan' + '-' + 'barış'", vec![BramaPrimative::Text(Arc::new("erhan".to_string())), BramaPrimative::Text(Arc::new("-".to_string())), BramaPrimative::Text(Arc::new("barış".to_string()))]);
