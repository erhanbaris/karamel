...
mod tests {
    ...
    test_last_memory!(vm_3, "'erhan' + 'barış'", KaramelPrimative::Text(Rc::new("erhanbarış".to_string())));
    //test_last_memory!(vm_4, "'erhan' + 10", KaramelPrimative::Text(Rc::new("erhan10".to_string())));
    test_last_memory!(vm_5, "123.456 + 123.456", KaramelPrimative::Number(246.912));
    test_last_memory!(vm_6, "123 + 123.456", KaramelPrimative::Number(246.45600000000002));
    test_last_memory!(vm_7, "123.456 + 123", KaramelPrimative::Number(246.45600000000002));
    //test_last_memory!(vm_8, "'erhan' + 10.1", KaramelPrimative::Text(Rc::new("erhan10.1".to_string())));
    //test_last_memory!(vm_9, "'erhan' + doğru", KaramelPrimative::Text(Rc::new("erhandoğru".to_string())));
    //test_last_memory!(vm_10, "'erhan' + false", KaramelPrimative::Text(Rc::new("erhanyanlış".to_string())));
    test_last_memory!(vm_11, "10 - 10", KaramelPrimative::Number(0.0));
    test_last_memory!(vm_12, "110.0 - 10.0", KaramelPrimative::Number(100.0));
    test_last_memory!(vm_13, "110 - 10.0", KaramelPrimative::Number(100.0));
    test_last_memory!(vm_14, "110.0 - 10", KaramelPrimative::Number(100.0));
    test_last_memory!(vm_15, "'data' - 10", KaramelPrimative::Empty);
    test_last_memory!(vm_16, "(doğru ve doğru)", KaramelPrimative::Bool(true));
    test_last_memory!(vm_17, "(doğru ve yanlış)", KaramelPrimative::Bool(false));
    test_last_memory!(vm_18, "(doğru == yanlış)", KaramelPrimative::Bool(false));
    test_last_memory!(vm_19, "(doğru == doğru)", KaramelPrimative::Bool(true));
    test_last_memory!(vm_20, "100 == 100.0", KaramelPrimative::Bool(true));
    test_last_memory!(vm_21, "'erhan' == 'erhan'", KaramelPrimative::Bool(true));
    test_last_memory!(vm_22, "100 == 110.0", KaramelPrimative::Bool(false));
    test_last_memory!(vm_23, "10 + 20 == 40.0 - 10", KaramelPrimative::Bool(true));
    test_last_memory!(vm_24, "(doğru != yanlış)", KaramelPrimative::Bool(true));
    test_last_memory!(vm_25, "(doğru != doğru)", KaramelPrimative::Bool(false));
    test_last_memory!(vm_26, "100 != 100.0", KaramelPrimative::Bool(false));
    test_last_memory!(vm_27, "'erhan' != 'erhan'", KaramelPrimative::Bool(false));
    test_last_memory!(vm_28, "100 != 110.0", KaramelPrimative::Bool(true));
    test_last_memory!(vm_29, "10 + 20 != 40.0 - 10", KaramelPrimative::Bool(false));
    test_last_memory!(vm_30, "100 > 110.0", KaramelPrimative::Bool(false));
    test_last_memory!(vm_31, "100 < 110.0", KaramelPrimative::Bool(true));
    test_last_memory!(vm_32, "100 >= 110.0", KaramelPrimative::Bool(false));
    test_last_memory!(vm_33, "100 <= 110.0", KaramelPrimative::Bool(true));
    test_last_memory!(vm_34, "110 >= 110.0", KaramelPrimative::Bool(true));
    test_last_memory!(vm_35, "110 <= 110.0", KaramelPrimative::Bool(true));
    test_last_memory!(vm_36, "'erhan' * 2", KaramelPrimative::Text(Rc::new("erhanerhan".to_string())));
    test_last_memory!(vm_37, "2 * 2", KaramelPrimative::Number(4.0));
    test_last_memory!(vm_38, "2.0 * 20", KaramelPrimative::Number(40.0));
    test_last_memory!(vm_39, "'erhan' * 2 == 'erhanbaris'", KaramelPrimative::Bool(false));
    test_last_memory!(vm_40, "'erhan' * 2 == 'erhanerhan'", KaramelPrimative::Bool(true));
