...
fonk test():
    erhan=123"#,
        Ok(Rc::new(KaramelAstType::FunctionDefination {
            name: "test".to_string(),
            arguments: Vec::new(),
            body: Rc::new(KaramelAstType::Block(
                [
                    ...
                    Rc::new(KaramelAstType::Return(Rc::new(KaramelAstType::None)))
                ]
                .to_vec()
            ))
        }))
        ...
        Ok(Rc::new(KaramelAstType::FunctionDefination {
            ...
            body: Rc::new(KaramelAstType::Block(
                [
                    ...
                    Rc::new(KaramelAstType::Return(Rc::new(KaramelAstType::Symbol("erhan".to_string()))))
                ]
                .to_vec()
            ))
        }))
