...
mod tests {
    ...
    test_success!(test_1, "'merhaba dünya'", Ok(BramaAstType::Primative(BramaPrimative::Text(Rc::new("merhaba dünya".to_string())))));
    test_success!(test_2, "\"merhaba dünya\"", Ok(BramaAstType::Primative(BramaPrimative::Text(Rc::new("merhaba dünya".to_string())))));
    ...
    test_success!(list_5, "[123,doğru,:erhan_barış,'merhaba dünya',1.3]", Ok(BramaAstType::Primative(BramaPrimative::List([Box::new(BramaAstType::Primative(BramaPrimative::Number(123.0))), Box::new(BramaAstType::Primative(BramaPrimative::Bool(true))), Box::new(BramaAstType::Primative(BramaPrimative::Atom("erhan_barış".atom()))), Box::new(BramaAstType::Primative(BramaPrimative::Text(Rc::new("merhaba dünya".to_string())))), Box::new(BramaAstType::Primative(BramaPrimative::Number(1.3)))].to_vec()))));
