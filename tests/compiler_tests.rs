...
mod tests {
    ...
    memory_check!(memory_5, "'erhan' + 'barış'", vec![BramaPrimative::Text("erhan".to_string()), BramaPrimative::Text("barış".to_string()), BramaPrimative::Empty]);
    memory_check!(memory_6, "'erhan' + '-' + 'barış'", vec![BramaPrimative::Text("erhan".to_string()), BramaPrimative::Text("-".to_string()), BramaPrimative::Text("barış".to_string()), BramaPrimative::Empty, BramaPrimative::Empty]);
